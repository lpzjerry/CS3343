...
public class CustomerTest {
	...
	public void testGetOrderLocation() {
		Customer mock = EasyMock.createMock(Customer.class); StubPosition
		expectedPos=new StubPosition(6,7);
		EasyMock.expect(mock.getOrderLocation(1)).andReturn(expectedPos);
		EasyMock.replay(mock); Position result=mock.getOrderLocation(1);
		assertEquals(expectedPos, result); EasyMock.verify(mock);
	}
